...
Source0  : https://github.com/tmux/tmux/releases/download/3.2a/tmux-3.2a.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1623341535
...
cp %{_builddir}/tmux-3.2a/COPYING %{buildroot}/usr/share/package-licenses/tmux/a8d32eee6673ecc60a6b42b9f33211ba184950db
%make_install
