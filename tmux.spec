...
Source0  : https://github.com/tmux/tmux/releases/download/3.5/tmux-3.5.tar.gz
...
%prep
%setup -q -n tmux-3.5
cd %{_builddir}/tmux-3.5
pushd ..
cp -a tmux-3.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727475217
